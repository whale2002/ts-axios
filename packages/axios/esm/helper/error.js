...
export var AxiosError = /*#__PURE__*/function (_Error) {
  ...
  function AxiosError(message, config, code, request, response) {
    ...
    _defineProperty(_assertThisInitialized(_this), "isAxiosError", void 0);
    ...
    Object.setPrototypeOf(_assertThisInitialized(_this), AxiosError.prototype);
    return _this;
  }
